  ...
  <el-card class="card-box">
    ...
    <el-table height="450px" :data="list" style="width: 100%">
      ...
      <!--
        ...
        parentKey 父节点的id 绑定到父id属性 区分父子节点
        levelKey 绑定到层级的属性 当前节点的级别
        childKey 绑定到储存子元素的属性 子节点
       -->
      <el-tree-grid
        prop="cat_name"
        label="分类名称"
...
// 引入element-tree-grid 增强了el-table的单元格
...
export default {
  ...
  methods: {
    ...
    // 点击对话框的确定按钮,发送请求, 添加商品分类信息
    async handleAdd() {
      // cat_level cat_pid
      // 分类的父id
      // 如果级联下拉框 没有选择 cat_pid=0
      // 如果级联下拉框 选中一级 cat_pid=selecetdOptions[0]
      // 如果级联下拉框 选中二级 cat_pid=selectedOptions[1]
      // 一级分类
