    ...
    <el-table :data="rolelist" style="width: 100%">
         <el-table-column type="expand" width="180"> 
             <template slot-scope="scope">
                 <!-- 展开一级权限 -->
                 <el-row class="roleslist" v-for="(item1,i) in scope.row.children" :key="i">
                     <el-col :span="4">
                     ...
                     <el-col :span="20">
                         ...
                         <el-row v-for="(item2,i) in item1.children" :key="i">
                             ...
                             <!-- 展开三级权限 -->
                             <el-col :span="20">
                                 <el-tag type="warning" closable v-for="(item3,i) in item2.children" :key="i">{{item3.authName}}</el-tag>
                             </el-col>
                         </el-row>
                     </el-col>
                 </el-row>
